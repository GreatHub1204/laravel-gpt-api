    ...
    <div>
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
            ...
            <p class="mt-6 text-gray-500 leading-relaxed">
                0r1kul is an AI generator used to create all sorts of content. Make unlimited requests for $9.99 a month. Use 0r1kul to create images, code and text.
            </p>
        </div>
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="ml-3 text-xl font-semibold text-gray-900">
                        <a href="https://laravel.com/docs">For Artists</a>
                    </h2>
                </div>
            ...
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="ml-3 text-xl font-semibold text-gray-900">
                        <a href="https://laracasts.com">For Business</a>
                    </h2>
                </div>
            ...
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="ml-3 text-xl font-semibold text-gray-900">
                        <a href="https://tailwindcss.com/">For Developers</a>
                    </h2>
                </div>
